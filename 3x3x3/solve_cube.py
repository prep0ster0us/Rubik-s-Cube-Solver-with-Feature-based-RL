...
def decode_postion(cube):
    """
    Decode current state of the cube.
    Defined as the location of color tiles (relative to a base model)
    BASE MODEL : F = red, R = yellow, B = orange, L = white, U = blue, D = green
    """
